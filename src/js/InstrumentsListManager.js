...
export default class InstrumentsListManager extends UIManager {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <p> 
                                ...
                                <span class="glyphicon glyphicon-star-empty"></span>
                                <button class="btn btn-default btn-like glyphicon glyphicon-heart" data-id= "${instrument.id}"/>
                            </p>    
  ...
  saveLikes(instrumentId) {
    if (!this.supportsLocalStorage()) {

    } else {
      localStorage.setItem("lvdp_1",instrumentId);
    }
  }

  findLikeInLocalStorage(instrumentId){
    return loca;
  }
}
